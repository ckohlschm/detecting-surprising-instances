...
def read_parameters(request):
    ...
    if 'submit_parameters_random_walk' in request.POST:
        read_parameters_random_walk(request)
...
def read_parameters_random_walk(request):
    target_attribute_name = request.POST['target_attribute']
    request.session['target_attribute'] = target_attribute_name
    print('Selected target attribute: ' + str(target_attribute_name))
    target_attribute_type = request.POST['target_attribute_type']
...
def read_parameters_supervised_learning(request):
    ...
    request.session['target_attribute_threshold'] = target_attribute_threshold
    print('Selected threshold : ' + str(target_attribute_threshold))
    supervised_learning_correlation_method = request.POST['supervised_learning_correlation_method']
    request.session['supervised_learning_correlation_method'] = supervised_learning_correlation_method
    print('Selected correlation threshold : ' + str(supervised_learning_correlation_method))
    supervised_learning_correlation_threshold = request.POST['supervised_learning_correlation_threshold']
    request.session['supervised_learning_correlation_threshold'] = supervised_learning_correlation_threshold
    print('Selected correlation threshold : ' + str(supervised_learning_correlation_threshold))
